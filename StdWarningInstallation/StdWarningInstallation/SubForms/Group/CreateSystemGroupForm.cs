...
{
    public partial class CreateSystemGroupForm : SystemGroupBaseForm
    {
        public CreateSystemGroupForm()
        {
            InitializeComponent();

            this.SetProfileUpdateMode(DataClass.ProfileUpdateMode.Regist);
        }
